  ...
  return (
    <div className='flex flex-col justify-center items-center' >
        ...
        <div className='drop-shadow-4xl w-[70%] h-52 rounded-xl mt-10 text-gray' >
            <div className='flex p-7 pl-9 drop-shadow-4xl rounded-xl w-full h-full bg-blueTheme gap-12' >
                ...
                <div className='w-[18%] drop-shadow-4xl h-full flex justify-center items-center ' >
